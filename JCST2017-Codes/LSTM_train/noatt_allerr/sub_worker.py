...
train_cmd = "python train.py {} {} {} {} {} {} {} {} {}".format(save_path,model_dir,vocab_size,word_emb_dim,hidden_dim,nEpochs,max_line,max_seq_len,log_file)
